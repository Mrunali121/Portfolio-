...
Live site: **https://Mrunali Rajgor.github.io/**
...
documentation, based in Berlin, Germany.

## What's in this repo

| File | Purpose |
|---|---|
| [`index.html`](index.html) | The portfolio site itself — experience, education, skills, and a featured project |
| [`CV_Mrunali.pdf`](CV_Mrunali.pdf) | Downloadable CV, linked from the site's "Download CV" button |
| [`profile.jpg`](profile.jpg) | Profile photo used in the site header |

## Featured project

The site links out to **[FitTrack](https://Mrunali Rajgor.github.io/fittrack-agile-pm-portfolio/)**,
